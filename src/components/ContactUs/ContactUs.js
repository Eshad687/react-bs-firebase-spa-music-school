    ...
    return (
        <Container className="text-center text-white">
            ...
            <Row className="g-4 py-5">
                <Col md={6}>
                    <div className="bg-info p-3 rounded card">
                ...
                <Col md={6} >
                    <div className="bg-warning p-3 rounded card">
                ...
                <Col md={6}>
                    <div className="bg-danger p-3 rounded  card">
